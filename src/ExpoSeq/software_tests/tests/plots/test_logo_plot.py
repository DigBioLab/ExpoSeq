...
def test_logo_plot():
    ...
    logo_instance = LogoPlot(ax, sequencing_report, region_string = "aaSeqCDR3", sample = ["GeneMind_1"], chosen_seq_length=None,
             highlight_spec_position=None, font_settings=font_settings, method = "", color_scheme = "hydrophobicity", avail_regions=["CDR3"])
    logo_instance2 = LogoPlot(ax, sequencing_report, region_string = "aaSeqCDR3",
                              sample = ["GeneMind_1"], chosen_seq_length=5, highlight_spec_position=False, font_settings = font_settings, method = "", color_scheme="hydrophobicity", avail_regions=["CDR3"])
    ...
    logo_instance4 = LogoPlot(ax, sequencing_report, region_string = "aaSeqCDR3",
                              sample = ["GeneMind_1"], chosen_seq_length=6,
                              highlight_spec_position=None ,font_settings = font_settings, method = "", color_scheme="hydrophobicity", avail_regions=["CDR3"])

    fig = plt.figure(1, constrained_layout=True)
    ax = fig.gca()
    logo_instance5 = LogoPlot(ax, sequencing_report, region_string = "aaSeqCDR3",
                              sample = ["GeneMind_1"], chosen_seq_length=5,
                              highlight_spec_position=None, font_settings = font_settings, method = "", color_scheme="hydrophobicity", avail_regions=["CDR3"])
