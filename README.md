...
The pipeline is able to utilize to generate a whole report automatically based on the the results generated by the pipeline. You can have a look at a generated example <a href="additional_material/test_randoms.html.gz" target="_blank">here</a>. Before you can use this funcitonality you need to install [Quarto](https://quarto.org/docs/get-started/) on your system. I used it in [VS Code](https://code.visualstudio.com/). After you have installed quarto you can run: 
<br>
```python
plot.create_report()
```
